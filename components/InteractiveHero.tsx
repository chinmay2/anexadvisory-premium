...
// Architectural hero selected to better match the reference composition:
// curved glass facade, dusk lighting and a cinematic real-estate feel.
const heroImage =
  "https://images.pexels.com/photos/28589265/pexels-photo-28589265.jpeg?auto=compress&cs=tinysrgb&w=2400";
...
export default function InteractiveHero() {
  ...
  return (
    ...
    >
      ...
      <div className="reference-hero__rail" aria-hidden="true">
        <span>01</span><i /><b />
      </div>

      <div className="container reference-hero__inner">
        <div className="reference-hero__copy">
          <div className="reference-hero__eyebrow">
            ANEX ADVISORY <span /> REAL ESTATE INTELLIGENCE
          </div>
          <h1 id="hero-title">
            Advisory for<br />
            decisions that<br />
          ...
          <p>
            Strategic advisory and project intelligence for organizations navigating complex opportunities, investments and growth.
          </p>
          <div className="reference-hero__actions">
            <Link className="reference-hero__primary" href="/contact">
              Start a conversation <span>↗</span>
            </Link>
            <Link className="reference-hero__secondary" href="/projects">
      ...
      <div className="reference-hero__location" aria-hidden="true">
        <span>MUMBAI</span><i /><span>INDIA</span>
      </div>
      ...
      <style jsx>{`
        ...
        /*
         * The reference uses a full cinematic architectural frame rather than a
         * cropped facade. Cover keeps the image edge-to-edge while the position
         * keeps the important building mass toward the right, leaving clean dark
         * negative space behind the typography.
         */
        .reference-hero__image{
          z-index:-5;
          width:100%;
        ...
        .reference-hero:hover .reference-hero__image{
          ...
          filter:saturate(.7) contrast(1.08) brightness(.61);
        }

        /* Strong left-to-right cinematic grade matching the reference. */
        .reference-hero__shade{
          z-index:-4;
          background:
        ...
        .reference-hero__blueGlow{
          z-index:-3;
          background:
            radial-gradient(circle at 91% 34%,rgba(36,72,255,.46),transparent 29%),
            radial-gradient(circle at 76% 70%,rgba(214,161,78,.14),transparent 26%);
        ...
        .reference-hero__primary{
          background:linear-gradient(135deg,#f1c477,#ce9548);
          color:#111;
          box-shadow:0 16px 40px rgba(204,148,70,.2);
        }

        .reference-hero__secondary{
          color:#f3eee5;
          border:1px solid rgba(255,255,255,.28);
          background:rgba(4,11,16,.24);
          backdrop-filter:blur(8px);
        }

        .reference-hero__actions span{font-size:16px;line-height:1}
        ...
        .reference-hero__halo{
          ...
          top:0;
          border-radius:50%;
          background:radial-gradient(circle,rgba(236,190,108,.17),transparent 68%);
          filter:blur(22px);
        }

        .reference-hero__orb{
          position:absolute;
          border:1px solid rgba(230,180,103,.28);
          border-radius:50%;
          background:radial-gradient(circle at 32% 25%,rgba(255,255,255,.72),rgba(255,255,255,.06) 25%,rgba(206,153,73,.12) 58%,rgba(0,0,0,.1) 78%);
          box-shadow:inset -18px -22px 42px rgba(0,0,0,.24),0 20px 70px rgba(0,0,0,.25);
        ...
        .reference-hero__glass{
          ...
          right:13%;
          top:30%;
          border:1px solid rgba(230,180,103,.55);
          border-radius:32px;
          background:linear-gradient(145deg,rgba(206,153,74,.48),rgba(7,19,27,.34) 42%,rgba(0,0,0,.05));
          transform:rotateX(58deg) rotateZ(-23deg);
          box-shadow:0 35px 100px rgba(0,0,0,.4),inset 0 1px 1px rgba(255,255,255,.25);
        ...
        .reference-hero__rail i{width:1px;height:52px;background:rgba(255,255,255,.22)}
        ...
        .reference-hero__location i{width:22px;height:1px;background:rgba(217,166,95,.6)}

        @media(max-width:1200px){
          .reference-hero__image{background-position:60% 54%}
          .reference-hero__copy{width:min(610px,58vw)}
        }

        @media(max-width:900px){
          .reference-hero{min-height:820px;height:auto;padding:125px 0 190px}
          .reference-hero__image{background-position:58% 50%}
          ...
          .reference-hero__location{display:none}
        }

        @media(max-width:600px){
          .reference-hero{min-height:900px}
          .reference-hero__image{background-position:58% 48%;filter:saturate(.58) contrast(1.05) brightness(.5)}
          ...
          .reference-hero__stats>div{gap:8px;padding:9px 7px}
          .reference-hero__stats strong{font-size:20px}
          .reference-hero__stats span{font-size:7px}
          .reference-hero__rail{display:none}
        }

        @media(prefers-reduced-motion:reduce){
          .reference-hero__image,.reference-hero__visual{transition:none}
        }
      `}</style>
    </section>
  );
